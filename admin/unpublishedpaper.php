<?php 
     $TITLE = "UnPublished Paper- IUBAT Review";
                                ...
                                <b>
                                    <small>
                                        ...
                                        <?php  
                                            ...
                                            echo returnSingleValue($USER_DB,"title","primaryemail",$authoremail).returnSingleValue($USER_DB,"firstname","primaryemail",$authoremail).returnSingleValue($USER_DB,"title","middlename",$authoremail).returnSingleValue($USER_DB,"lastname","primaryemail",$authoremail);
                                            ?>
