    ...
    <div id="main">
        ...
        <?php echo display_message(); ?>
            ...
            <form class="form-signup marginbtm" action="../link/updateprofile.php" method="post">
                ...
                <input style="font-size:11px;" type="text" id="pemail" class="form-control" name="fullname" placeholder="Fullname" required="" value="<?php echo returnSingleValue($CHIEFEDITOR_DB,"fullname","email",$editoremail); ?>">
                ...
                <input style="font-size:11px;" type="text" id="user-name" class="form-control" name="contact" placeholder="Secondary Email Address" required="" value="<?php echo returnSingleValue($CHIEFEDITOR_DB,"contact","email",$editoremail); ?>">
